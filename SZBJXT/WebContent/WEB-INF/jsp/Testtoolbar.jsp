...
<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addzhizao()"></a>
		...
		<div>
			 <span>布号:</span> <input id="cloth_id"  style="width:80px">
			 <span>机型:</span> <input id="model"  style="width:80px" >		 
			Language: 
			...
			<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="searchtoolbar()">Search</a>
		</div>
	</div>
