...
<script type="text/javascript" src="/js/ranzheng.js"></script>	 
</head>
<body>
 <%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="UTF-8"%>
	<h2>染整价格管理信息</h2>
	<p>用户可在此进行对染整信息的修改  注：保存状态并无实际生产效果，提交后才生效</p>
	<div style="margin:20px 0;"></div>
 
	<table id="ranzhengtable"  title="染整价格信息" style="width:1200px;height:650px">		 		 
		<thead>
			<tr>
				...
				<th data-options="field:'ranzheng_fee',width:120,align:'right'">染整费用（KG/元)</th>	 				
...
<div id="dlg" class="easyui-dialog" style="font-size:18px;width:500px;height:420px;padding:10px 20px" closed="true" buttons="#dlg-buttons">  
    <div class="ftitle">染整信息</div>  
    <form id="ranzhengForm" method="post" action="" style="margin-top:10px;">  
...
<div id="dlg-buttons">  
    <a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveranzheng()">save</a>  
